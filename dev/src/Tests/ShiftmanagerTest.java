...
//        manager = new Employee(1, "John Doe", "123456",roles1,LocalDate.now(), "full-time", "hourly", 100, 21);
//        employee = new Employee(2, "Jane", "654321",roles2,LocalDate.now(), "full-time", "hourly", 100, 21);
...
//        assertNotNull(shift);
//        assertEquals(4, shift.getRolesneeded());
