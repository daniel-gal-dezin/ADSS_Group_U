...
public class EmployeeTest {
    ...
    public void testAddRole() {
        Employee employee = new Employee(1, "John", "123456", Arrays.asList(Role.CASHIER), null,false);
        employee.addRole("DRIVER");
        assertTrue(employee.getRoles().contains(Role.DRIVER));
    }
    @Test
    public void testRemoveRole() {
        Employee employee = new Employee(1, "John", "123456", Arrays.asList(Role.CASHIER, Role.DRIVER), null,false);
