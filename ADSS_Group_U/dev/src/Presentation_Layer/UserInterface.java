    ...
    public void hr_loop(int bId) {
        while (true) {
            ...
            if (input.equals("1")) { //add employee
                ...
                int productId = numberChecker();
                System.out.println("enter item id");
                int itemId = numberChecker();
                output = bs.addDelivery(bId,year,month,day,sType==1?"morning":"evening",id1,id2,lisence.charAt(0), productId, itemId);
