...
//from here relevant functions for delivery
    ...
    public int addDelivery(int branchid, LocalDate date, String stype, int driverid, int storekeeperid,char lisence, int productId, int itemId) throws Exception {
        ...
        return branches.get(branchid).addDelivery(date,stype,e1,e2,lisence,productId,itemId);
    }
