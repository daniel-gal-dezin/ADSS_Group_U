...
public class DeliveryManager {
    ...
    public int addDelivery(Shift shift,  Employee driver, Employee store_keeper, char license,int productId, int itemId) throws Exception {
        Delivery newDel = new Delivery(delivery_id_counter, driver,store_keeper,license, productId, itemId);
        delivery_id_counter++;
